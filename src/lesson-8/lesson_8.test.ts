import {
    getBanknoteList, getSum, getTriangleType, isEvenIndexSumGreater,
    getSquarePositiveIntegers, sumFirstNumbers, sum1
} from './lesson_8';


test("sum", () => {
    expect(sum1(3, 5, 7, 6, 4, 9)).toBe(34)
    expect(sum1(1, 1, 1, 6)).toBe(9)
})
